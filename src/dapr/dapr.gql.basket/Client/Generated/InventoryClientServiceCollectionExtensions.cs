...
namespace dapr.gql.basket
{
    ...
    public static partial class InventoryClientServiceCollectionExtensions
    {
        private const string _clientName = "InventoryClient";

        public static IOperationClientBuilder AddInventoryClient(
            this IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddSingleton<IInventoryClient, InventoryClient>();
            ...
            IOperationClientBuilder builder = serviceCollection.AddOperationClientOptions(_clientName)
                .AddResultParser(serializers => new ReserveResultParser(serializers))
