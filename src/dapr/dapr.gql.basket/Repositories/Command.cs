...
namespace dapr.gql.basket.Repositories
{
    ...
    public class Command {
        ...
        /// <returns></returns>
        public BasketItem UpsertItemToBasket(BasketItem item, [Service] BasketRepository repository)=> repository.Add(item);
        /// <summary>
        ...
        /// <param name="repository">The repository where this item is stored</param>
        public void RemoveItemFromBasket(int basketItemId, [Service] BasketRepository repository) => repository.Remove(basketItemId);
    }
}